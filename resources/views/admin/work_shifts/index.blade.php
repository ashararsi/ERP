        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    <h3 class="text-22 text-midnight text-bold mb-4">Work Shifts List</h3>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered" id="data-table">
                        ...
                        <tr>
                            ...
                            <th>Shift Time</th>
                            <th>Break Time</th>
                            <th>Hours (Total / Working / Break)</th>
                            <th>Status</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
            ...
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: 'hours',
                        render: function (data, type, row) {
                            return row.hours_per_day + 'h / ' + row.working_hours_per_day + 'h / ' + row.break_hours_per_day + 'h';
                        }
                    },
                    {
                        data: 'status',
