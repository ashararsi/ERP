        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="box-body" style="margin-top:40px;">
                    {!! Form::hidden('entry_type_id', old('entry_type_id', '1'),['id'=>'entry_type_id']) !!}
                    ...
                    {!! Form::close() !!}
                    @include('accounts.entries.voucher.journal_voucher.intrument_entries_template',['vendor'=>$vendor,'vendorDropdown'=>$vendorDropdown])
