<div class="row col-sm-12">
    ...
    {{--        {!! Form::select('entry_type_id', array('1'=>'Cash Receipt Voucher'), $VoucherData['entry_type_id'], ['style' => 'width: 100%;', 'class' => 'form-control select2','required']) !!}--}}
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <table class="table table-condensed" id="entry_items">
                ...
                @endif
                <tr>
                    <td colspan="5" style="padding-top: 12px;" width="">
