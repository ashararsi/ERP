@php
    use App\Helpers\SidebarPermissions;
@endphp
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="{!! route('dashboard') !!}" class="header-logo">
            <img src="{!! asset('logo.png') !!}" style="height: 5rem;" alt="logo" class="desktop-logo">
            <img src="{!! asset('logo.png') !!}" style="height: 5rem;" alt="logo" class="toggle-logo">
            <img src="{!! asset('logo.png') !!}" style="height: 5rem;" alt="logo" class="desktop-white">
            <img src="{!! asset('logo.png') !!}" style="height: 5rem;" alt="logo" class="toggle-white">
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                @canany(SidebarPermissions::get('user_management'))
                    ...
                    <li
                        ...
                        <ul class="slide-menu child1">
                            ...
                            @can('View Users List')
                                <li
                                    class="slide has-sub {{ request()->routeIs('admin.users.index') && !request()->has('role') ? 'active open' : '' }}">
                                ...
                                {{-- QA Users --}}
                                <li
                                    class="slide has-sub {{ request()->routeIs('admin.users.index') && request()->input('role') === 'QA' ? 'active open' : '' }}">
                                ...
                                {{-- Operator Users --}}
                                <li
                                    class="slide has-sub {{ request()->routeIs('admin.users.index') && request()->input('role') === 'Operator' ? 'active open' : '' }}">
                ...
                @canany(SidebarPermissions::get('inventory'))
                        ...
                        <ul class="slide-menu child1">
                            @can('View Purchase Order List')
                                <li class="slide has-sub {{ request()->is('admin/purchaseorders*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.purchaseorders.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.purchaseorders.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.purchaseorders.create') ? 'active' : '' }}">
                            ...
                            @can('View Raw List')
                                <li class="slide has-sub {{ request()->is('admin/raw-material*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.raw-material.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.raw-material.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.raw-material.create') ? 'active' : '' }}">
                            ...
                            @can('View Packing Material')
                                <li class="slide has-sub {{ request()->is('admin/packing-materials*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.packing-materials.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.packing-materials.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.packing-materials.create') ? 'active' : '' }}">
                            ...
                            @can('View Formulation')
                                <li class="slide has-sub {{ request()->is('admin/formulations*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.formulations.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.formulations.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.formulations.create') ? 'active' : '' }}">
                            ...
                            @can('View Goods-Issuance List')
                                <li class="slide has-sub {{ request()->is('admin/goods-issuance*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.goods-issuance.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.goods-issuance.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.goods-issuance.create') ? 'active' : '' }}">
                            ...
                            @can('View Goods-Reciept')
                                <li class="slide has-sub {{ request()->is('admin/goods-receipt*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.goods-receipt.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.goods-receipt.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.goods-receipt.create') ? 'active' : '' }}">
                                ...
                                <li class="slide has-sub {{ request()->is('admin/pos*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li class="slide {{ request()->routeIs('admin.pos.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.pos.index') !!}" class="side-menu__item">List</a>
                                        </li>
                                ...
                                <li class="slide has-sub {{ request()->is('admin/customers*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li class="slide {{ request()->routeIs('admin.customers.index') ? 'active' : '' }}">
                                            <a href="{!! route('admin.customers.index') !!}" class="side-menu__item">List</a>
                                        </li>
                ...
                @canany(SidebarPermissions::get('location'))
                    <li
                ...
                @canany(SidebarPermissions::get('accounting'))
                        ...
                        <a href="javascript:void(0);" class="side-menu__item">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                ...
                                <path
                                    ...
                                    opacity=".3" />
                                <path
                                    d="M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm-1 6H5v-4h14v4zM7 19.5c.83 0 1.5-.67 1.5-1.5S7.83 16.5 7 16.5 5.5 17.17 5.5 18 6.17 19.5 7 19.5zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zm-1 6H5V5h14v4zM7 8.5c.83 0 1.5-.67 1.5-1.5S7.83 5.5 7 5.5 5.5 6.17 5.5 7 6.17 8.5 7 8.5z" />
                            </svg>
                        ...
                        <ul class="slide-menu child1">
                            ...
                            @can('View Groups', 'Create Groups')
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        @can('Create Groups')
                                            <li class="slide">
                                                <a href="{!! route('admin.account_groups.create') !!}" class="side-menu__item">Create</a>
                                            </li>
                                        @endcan
                                    </ul>
                                </li>
                            ...
                            @can('View Ledgers')
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        @can('Create Ledgers')
                                            <li class="slide">
                                                <a href="{!! route('admin.ledger.create') !!}" class="side-menu__item">Create</a>
                                            </li>
                                        @endcan
                                    </ul>
                                </li>
                            ...
                            @can('Create Vouchers')
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child2">
                                        @can('Create Vouchers')
                                            <li class="slide"><a href="{!! route('admin.gjv-create') !!}" class="side-menu__item">GJV
                                                    Create</a></li>
                                            <li class="slide"><a href="{!! route('admin.crv-create') !!}" class="side-menu__item">CRV
                                                    Create</a></li>
                                            <li class="slide"><a href="{!! route('admin.brv-create') !!}" class="side-menu__item">BRV
                                                    Create</a></li>
                                            <li class="slide"><a href="{!! route('admin.cpv-create') !!}" class="side-menu__item">CPV
                                                    Create</a></li>
                                            <li class="slide"><a href="{!! route('admin.bpv-create') !!}" class="side-menu__item">BPV
                                                    Create</a></li>
                                        @endcan
                                        @can('View Entries')
                                            <li class="slide"><a href="{!! route('admin.entries.index') !!}" class="side-menu__item">All
                                                    Entries</a></li>
                                        @endcan
                                    </ul>
                                </li>
                ...
                @canany(SidebarPermissions::get('hr'))
                    <li
                        ...
                        <ul class="slide-menu child1">
                            ...
                            @can('View Leave Types')
                                <li class="slide has-sub {{ request()->is('admin/hrm-leave-types*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-types.index') ? 'active' : '' }}">
                                            <a href="{{ route('admin.hrm-leave-types.index') }}" class="side-menu__item">
                                                List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-types.create') ? 'active' : '' }}">
                            ...
                            @can('View Leave Entitlement')
                                <li class="slide has-sub {{ request()->is('admin/leave-entitlement*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.leave-entitlement.index') ? 'active' : '' }}">
                                            <a href="{{ route('admin.leave-entitlement.index') }}" class="side-menu__item">
                                                List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.leave-entitlement.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.leave-entitlement.create') }}"
                                                class="side-menu__item">Create</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            @can('View Leave Requests')
                                <li class="slide has-sub {{ request()->is('admin/hrm-leave-requests*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-requests.index') ? 'active' : '' }}">
                                            <a href="{{ route('admin.hrm-leave-requests.index') }}" class="side-menu__item">
                                                List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-requests.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.hrm-leave-requests.create') }}"
                                                class="side-menu__item">Create</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            @can('View Leaves')
                                <li class="slide has-sub {{ request()->is('admin/hrm-leaves*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leaves.create') ? 'active' : '' }}">
                            ...
                            @can('View Leave Statuses')
                                <li class="slide has-sub {{ request()->is('admin/hrm-leave-statuses*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-statuses.index') ? 'active' : '' }}">
                                            <a href="{{ route('admin.hrm-leave-statuses.index') }}" class="side-menu__item">
                                                List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.hrm-leave-statuses.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.hrm-leave-statuses.create') }}"
                                                class="side-menu__item">Create</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            @can('View Loan Plans')
                                <li class="slide has-sub {{ request()->is('admin/loan-plans*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li
                                            class="slide {{ request()->routeIs('admin.loan-plans.create') ? 'active' : '' }}">
                            ...
                            @can('View Work Shifts')
                                <li class="slide has-sub {{ request()->is('admin/work-shifts*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        <li
                                            class="slide {{ request()->routeIs('admin.work-shifts.index') ? 'active' : '' }}">
                                            <a href="{{ route('admin.work-shifts.index') }}" class="side-menu__item">
                                                List</a>
                                        </li>
                                        <li
                                            class="slide {{ request()->routeIs('admin.work-shifts.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.work-shifts.create') }}"
                                                class="side-menu__item">Create</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            @can('View Work Weeks')
                                <li class="slide has-sub {{ request()->is('admin/work-weeks*') ? 'open' : '' }}">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li
                                            class="slide {{ request()->routeIs('admin.work-weeks.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.work-weeks.create') }}"
                                                class="side-menu__item">Create</a>
                                        </li>
                                    </ul>
                                </li>
