...
{{--                </li>--}}
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">User Mangement</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide has-sub">
                ...
                <li class="slide has-sub open">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub open ">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide active">
                                    <a href="{!! route('admin.processes.index') !!}" class="side-menu__item">Processes</a>
                                </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="{!! route('admin.raw-material.index') !!}" class="side-menu__item">Products</a>
                                </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="javascript:void(0);" class="side-menu__item">create</a>
                                </li>
