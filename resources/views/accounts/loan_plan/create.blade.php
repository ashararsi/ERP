    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- /.box-body -->
                <button id="btn" class="btn btn-success col-md-12">Add New Loan Plan</button>
