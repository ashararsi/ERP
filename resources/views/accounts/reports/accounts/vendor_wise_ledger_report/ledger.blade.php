                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <select name='vendor_id' class="form-control vendor_id" id="vendor_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="display: flex !important; ">
                                        <button type="submit" class="btn btn-sm btn-default"
                                                formaction="vendor-wise-ledger-report-print?type=print" formmethod="post"
                                        ...
                                        <button type="submit" class="btn btn-sm btn-default"
                                                formaction="vendor-wise-ledger-report-print?type=excel" formmethod="post"
    ...
    <script>
        function fetch_ledger() {
            $.ajax({
                ...
                url: '{{ route('admin.vendor-wise-ledger_report_print')}}',
