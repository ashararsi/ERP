        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0 flex-grow-1" style="float:left;">Add New Groups</h4>
                    <a href="{{ route('admin.groups.index') }}" style="float:right;" class="btn btn-success pull-right">Back</a>

                </div><!-- end card header -->

                <div class="card-body">
                    {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'route' => ['admin.groups.store'],
                    'id' => 'validation-form']) !!}
                    <div class="box-body">
                    ...
                    <!-- /.box-body -->
                    <button id="btn" class="btn btn-success col-md-12">Add New Group</button>
