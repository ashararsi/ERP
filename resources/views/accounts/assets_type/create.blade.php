    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0 flex-grow-1" style="float:left;">Add New Assets Types</h4>
                <a href="{{ route('admin.assets-types.index') }}" style="float:right;" class="btn btn-success pull-right">Back</a>

            </div><!-- end card header -->

            <div class="card-body">
                {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'route' => ['admin.assets-types.store'],
                'id' => 'validation-form']) !!}
                <div class="box-body">
                    <div class="form-group col-md-12 @if($errors->has('name')) has-error @endif" style="float:left;">
                        ...
                        'Enter Assets Types','maxlength'=>'50']) !!}
                        @if($errors->has('name'))
                ...
                <!-- /.box-body -->
                <button id="btn" class="btn btn-success col-md-12">Add New Assets Types</button>
