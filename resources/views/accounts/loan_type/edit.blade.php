    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0 flex-grow-1" style="float:left;">Edit Loan Type</h4>
            ...
            <div class="card-body">
                ...
                {!! Form::model($loan, ['method' => 'PUT', 'id' => 'validation-form', 'route' => ['admin.loan-type.update', $loan->loan_id]]) !!}
                ...
                <!-- /.box-body -->
                <button id="btn" class="btn btn-success col-md-12">Edit Loan Type</button>
