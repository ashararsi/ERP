        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0 flex-grow-1" style="float:left;">Edit Ledger</h4>
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($ledger, ['method' => 'PUT', 'id' => 'validation-form', 'route' => ['admin.ledger.update', $ledger->id]]) !!}
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6 @if($errors->has('name')) has-error @endif"
                                ...
                                {!! Form::text('name', old('name'), ['id'=>'ledger_name','class' => 'form-control', 'placeholder' => '','maxlength'=>250]) !!}
                           ...
                           <div class="col-md-6 form-group" style = "float:left;">
                            ...
                            <div class="col-md-6 form-group @if($errors->has('branch_id')) has-error @endif"
                                ...
                                <select name='branch_id'
                                    ...
                                    @foreach($branches as $key=>$value)
                                        @if(Auth::user()->isAbleTo('Branch_'.$key))
                                            <option @if($ledger->branch_id==$key) selected
                            ...
                            <div class=" col-md-4 form-group @if($errors->has('balance_type')) has-error @endif"
                                ...
                                <select name="balance_type" class="form-control" required>
                                    ...
                                    <option value="d" @if($ledger->balance_type == 'd') selected @endif>Debit</option>
                                    <option value="c" @if($ledger->balance_type == 'c') selected @endif>Credit</option>
                                </select>
            ...
            {{ $errors->first('closing_balance') }}
                        ...
                        <!-- /.box-body -->
                        <button id="btn" class="btn btn-success col-md-12">Update Ledger</button>
