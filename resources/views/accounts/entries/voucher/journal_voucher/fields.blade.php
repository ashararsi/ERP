<div class="row col-sm-12">
    ...
    {{--<!-- <div class="form-group col-md-6 @if($errors->has('company_id')) has-error @endif">--}}
    {{--        {!! Form::label('company_id', 'Companies*', ['class' => 'control-label']) !!}--}}
    {{--{!! Form::select('company_id', array('5'=>'Companies'), $VoucherData['company_id'], ['style' => 'width: 100%;', 'class' => 'form-control','required']) !!}--}}
            ...
            <table class="table table-condensed" id="entry_items">
                            ...
                            <tr class="entry_item-{{ $val }} first_row">
                                <td colspan="5">
                                    <div class="form-group">
                                        {!! Form::hidden("entry_items[counter][$val]", $val, ['id' => "entry_item-counter-$val",
                                            'class' => "entry_item-counter-$val"]) !!}
                                        {!! Form::select("entry_items[ledger_id][$val]", ($VoucherData['entry_items']['ledger_id'][$val]) ?
                                            array($VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->id =>
                                            $VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->number . ' - ' .
                                            $VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->name) : array(),
                                            $VoucherData['entry_items']['ledger_id'][$val], ['id' => "entry_item-ledger_id-$val",
                                            'style' => 'width: 100%;', 'class' => 'form-control description-data-ajax classForNarration']) !!}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                ...
                @else
                    ...
                    <tr class="entry_item-1 first_row">
                        <td colspan="5">
                            <div class="form-group">
                                {!! Form::hidden('entry_items[counter][1]', '1', ['id' => "entry_item-counter-1",
                                    'class' => 'entry_item-counter-1']) !!}
                                {!! Form::select('entry_items[ledger_id][1]', array(), old('branch_id'),
                                ['id' => 'entry_item-ledger_id-1', 'style' => 'width: 100%;',
                                 'class' => 'form-control description-data-ajax classForNarration']) !!}
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                ...
                <tr>
                    ...
                    <td width="100%" style="display: inline-flex">
                        <div class="form-group  @if($errors->has('dr_total')) has-error @endif" style="">
                    ...
                    <td>
                        <div class="form-group @if($errors->has('cr_total')) has-error @endif" style="">
