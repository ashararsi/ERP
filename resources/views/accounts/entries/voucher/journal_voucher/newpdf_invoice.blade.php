                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="padding: 2px;">
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                ...
                                                @endphp
                                                    @if($Ledgers[$Entry_item->ledger_id]->parent_type==NULL) {{ $split[0] }} @else {{ $Ledgers[$Entry_item->ledger_id]->name }} @endif
                                                @else
                                                    N/A
                                                @endif
                                            </div>
                                        ...
                                        <td colspan="2" style="padding: 2px;">
                                            <div class="form-group" style="margin-bottom: 0px !important;  !important; float:right">
...
<!--footer-->
            ...
            @if($Entrie->dr_total - $Entrie->cr_total>0)
             <div class="authorised-sig" style=" margin-top: 30px;">
                <table style="width:100%">
                    <tr>
                        <td colspan="4">
                            <div class="form-group" style="margin-bottom: 0px !important; float:left">
                                <b>Difference:</b> 
                            </div>
                        </td>
                        <td colspan="2">
            ...
            @endif
            <div class="authorised-sig" style=" margin-top: 50px;">
                <table style="width:100%">
                    <tr>
                        <td><p style="display: inline-block; margin-left: 70px; margin-bottom: -20px;"></p></td>
                    </tr>
                    <tr>
