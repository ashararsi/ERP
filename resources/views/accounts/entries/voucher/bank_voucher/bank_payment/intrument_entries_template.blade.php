    ...
    <tr class="entry_item-######">
        ...
        <td>
            <div class="form-group" style="margin-bottom: 0px !important;">
                ...
                'onfocusout' => "FormControls.checkInstrumentNo(######)"
                ]) !!}
            </div>
        </td>
        <td><button id="entry_item-del_btn-######" onclick="FormControls.destroyEntryItem('######');" type="button" class="btn btn-danger btn-icon waves-effect waves-light"><i class="ri-delete-bin-5-line"></i></button></td>
    </tr>
    </tbody>
</table>
