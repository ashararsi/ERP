...
<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            ...
            <h3 class="box-title" style = "float:left;">View</h3>
            <a href="{{ route('admin.entries.index') }}" class="btn btn-success pull-right" style = "float:right;margin-bottom:20px;">Back</a>
            {{--<input type='button' id='btn' class="btn btn-success pull-right" value='Print' onclick='printDiv();'>--}}
            <a href="{{route('admin.entries.downloadPDF', $id)}}" target="_blank" style = "float:right;margin-right:20px;margin-bottom:20px;" class="btn btn-warning pull-right"> <u>P</u>df</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>Remarks</th>
                    <td colspan="4">@if($Entrie->remarks){{ $Entrie->remarks }}@else{{ 'N/A' }}@endif</td>
                </tr>
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="pull-right" style = "text-align: center; padding: 20px;color: black;"><a href="#tab_2" data-toggle="tab"><u>P</u>arameters</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <table class="table table-condensed" id="entry_items">
                                    ...
                                    <td colspan="3">
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                @if(isset($Ledgers) && !empty($Ledgers))
                                                    ...
                                                    if($prefix == '0'){
                                                        $text_ledger = '('. $Ledgers[$Entry_item->ledger_id]->groups['number'] .')';
                                                    }else{
                                                        $text_ledger = $prefix;
                                                    }
                                                    ?>
                                        ...
                                        <td align="right">
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                    @if($Ledgers[$Entry_item->ledger_id]->account_type_id ==1)
                                                    Receivables

                                                    @elseif($Ledgers[$Entry_item->ledger_id]->account_type_id ==4)
                                                    Income
                                                    @elseif($Ledgers[$Entry_item->ledger_id]->account_type_id ==5)
                                                    Payables or Liabilities
                                                    @endif
                                        ...
                                        <td align="right">
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                @if($Entry_item->dc == 'd'){{ $DefaultCurrency->symbol . ' ' . $Currency::curreny_format($Entry_item->amount) }}@else{{ $DefaultCurrency->symbol . ' ' . $Currency::curreny_format(0) }}@endif
                                            </div>
                                        </td>
                                        <td align="right">
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                @if($Entry_item->dc == 'c'){{ $DefaultCurrency->symbol . ' ' . $Currency::curreny_format($Entry_item->amount) }}@else{{ $DefaultCurrency->symbol . ' ' . $Currency::curreny_format(0) }}@endif
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group" style="margin-bottom: 0px !important;">
                            ...
                            @endif
                            <tr>
                                <td align="right" style="padding-top: 12px;" ><b>Difference</b></td>
