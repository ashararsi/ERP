...
<div class="form-group col-md-6 @if($errors->has('radio')) has-error @endif">
    <div>Voucher Type?</div>
    <label for="Cash">
        <input type="radio" id="c" name="entry_type_id" value="3" required/> Cash In Hand
    </label>
    <label for="bank">
        <input type="radio" id="a" name="entry_type_id" value="5"/> Bank payment
    </label>
    <label for="jvp">
        <input type="radio" id="a" name="entry_type_id" value="1"/> Journal voucher
    </label>
    @if($errors->has('radio'))
        <span class="help-block">
            {{ $errors->first('radio') }}
        ...
        <tbody>
            <tr>
                ...
                @else
                    <td width="60%">
                        <div class="form-group" style="margin-bottom: 0px !important;">
                            {!! Form::label('narration', 'A/C Cr*', ['class' => 'control-label']) !!}
                        ...
                        {!! Form::hidden('entry_items[lc_duties][1]', 0, [
                                'id' => 'entry_item-lc_duties-1',
                                'class' => 'form-control entry_items-lc_duties',
                        ]) !!}
...
<div class="row">
    {{--//{!! Form::hidden('entry_type_id', old('entry_type_id', '6')) !!}--}}
</div>
<!-- Slip Area Started -->
                        ...
                        @foreach ($VoucherData['entry_items']['counter'] as $key => $val)
                            ...
                            <tr id="entry_item-{{ $val }}">
                                <td colspan="3">
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        {!! Form::hidden("entry_items[counter][$val]", $val, ['id' => "entry_item-counter-$val", 'class' => "entry_item-counter-$val"]) !!}
                                        {!! Form::select("entry_items[ledger_id][$val]", ($VoucherData['entry_items']['ledger_id'][$val]) ?
                                        array($VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->id => $VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->number . ' - ' . $VoucherData['ledger_array'][$VoucherData['entry_items']['ledger_id'][$val]]->name) : array(), $VoucherData['entry_items']['ledger_id'][$val],
                                         ['id' => "entry_item-ledger_id-$val", 'style' => 'width: 100%;', 'class' => 'form-control description-data-ajax ']) !!}
                                    </div>
                                    {!! Form::hidden("entry_items[cr_amount][$val]", $VoucherData['entry_items']['cr_amount'][$val], [
                                        'id' => "entry_item-cr_amount-$val",
                                        'class' => 'form-control entry_items-cr_amount',
                                ...
                                <td>
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        {!! Form::select("entry_items[lc_duties][$val]", $DutyModel, null, ['id' => 'entry_item-lc_duties-2', 'style' => 'width: 100%;', 'class' => 'form-control','required']) !!}
                        ...
                        <tr id="entry_item-2">
                            <td colspan="3">
                                <div class="form-group" style="margin-bottom: 0px !important;">
                                    ...
                                    {!! Form::select('entry_items[ledger_id][2]', array(), null, ['id' => 'entry_item-ledger_id-2', 'style' => 'width: 100%;', 'class' => 'form-control description-data-ajax lcmargin']) !!}
                                </div>
                            ...
                            <td>
                                <div class="form-group" style="margin-bottom: 0px !important;">
                                    {!! Form::select('entry_items[lc_duties][2]', $DutyModel, null, ['id' => 'entry_item-lc_duties-2', 'style' => 'width: 100%;', 'class' => 'form-control']) !!}
                                </div>
                            </td>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px !important;">
