<div class="row col-sm-12">
    ...
    {{--        {!! Form::select('entry_type_id', array('3'=>'Cash Payment Voucher'), $VoucherData['entry_type_id'], ['style' => 'width: 100%;', 'class' => 'form-control select2','required']) !!}--}}
...
<div class="row">
    {!! Form::hidden('entry_type_id', old('entry_type_id', '3')) !!}
    {!! Form::hidden('suppliers_id', old('suppliers_id', '3')) !!}
</div>
<!-- Slip Area Started -->
