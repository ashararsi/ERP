...
<!--    <title>Sales Order Request</title>-->
<!--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">-->
<!--</head>-->
<!--<body>-->
<!--<div class="container mt-4">-->
<!--    <h2 class="text-center mb-4">Sales Order Request</h2>-->
<!--    <form>-->
<!--        <div class="row mb-3">-->
<!--            <div class="col-md-3">-->
<!--                <label for="sOrdNo" class="form-label">S.Ord No</label>-->
<!--                <input type="text" class="form-control" id="sOrdNo" name="sOrdNo" value="32017">-->
<!--            </div>-->
<!--            <div class="col-md-3">-->
<!--                <label for="sOrdDate" class="form-label">S.Ord Date</label>-->
...
<!--                <input type="text" class="form-control" id="customerName" name="customerName" value="HAKEEM BASHEER DAWAKHANA">-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="row mb-3">-->
<!--            <div class="col-md-3">-->
...
<!--                <input type="date" class="form-control" id="customerPODate" name="customerPODate" value="2025-03-24">-->
<!--            </div>-->
<!--            <div class="col-md-3">-->
<!--                <label for="city" class="form-label">City</label>-->
<!--                <input type="text" class="form-control" id="city" name="city" value="Kasur">-->
<!--            </div>-->
<!--            <div class="col-md-3">-->
...
<!--                <input type="text" class="form-control" id="salesRep" name="salesRep" value="Pervez Akhtar (0300-4380358)">-->
<!--            </div>-->
<!--        </div>-->
...
<!--                <input type="text" class="form-control" id="salesTax" name="salesTax" value="0">-->
<!--            </div>-->
<!--            <div class="col-md-3">-->
<!--                <label for="advanceTax" class="form-label">Advance Tax</label>-->
<!--                <input type="text" class="form-control" id="advanceTax" name="advanceTax" value="2.5">-->
<!--            </div>-->
<!--            <div class="col-md-3">-->
<!--                <label for="netTotal" class="form-label">Net Total</label>-->
<!--                <input type="text" class="form-control" id="netTotal" name="netTotal" value="17063.96">-->
<!--            </div>-->
<!--        </div>-->
