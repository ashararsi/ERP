...
var FormControlss = function () {
    ...
    var createEntryItem = function () {
        var global_counter = parseInt($('#bank_loans_entry_item-global_counter').val()) + 1;
        var entry_item = $('#bank_loans_entry_item-container').html().replace(/########/g, '').replace(/######/g, global_counter);
        $('#bank_loans_entry_items tr:last').before(entry_item);
        // Apply Select2 on newly created item
        $('#bank_loans_entry_item-ledger_id-'+global_counter).select2(Select2AjaxObj());
        $('#bank_loans_entry_item-global_counter').val(global_counter)
    }
