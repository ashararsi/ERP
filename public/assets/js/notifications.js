(function () {
    ...
    // notifier.modal(`<h4 class="fw-semibold mb-1 text-xl">Welcome To Bootstrap Admin Template </h4><small class="text-gray-500 text-sm">Click outside the modal window to close it.</small>`, 'demo')
    // })
    //
